...
CREATE EXTERNAL TABLE IF NOT EXISTS data_2010 LIKE data_2009 LOCATION '/user/flights/2010';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2011 LIKE data_2009 LOCATION '/user/flights/2011';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2012 LIKE data_2009 LOCATION '/user/flights/2012';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2013 LIKE data_2009 LOCATION '/user/flights/2013';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2014 LIKE data_2009 LOCATION '/user/flights/2014';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2015 LIKE data_2009 LOCATION '/user/flights/2015';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2016 LIKE data_2009 LOCATION '/user/flights/2016';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2017 LIKE data_2009 LOCATION '/user/flights/2017';
CREATE EXTERNAL TABLE IF NOT EXISTS data_2018 LIKE data_2009 LOCATION '/user/flights/2018';
